...
@section ("content")
    <div class="section header" style="background-image: url({{asset('storage/image-tekst_1.png')}})">
        <div class="container">
            <div class="row">
                <div class="col-sm"><h1>title<strong style=""></strong></h1></div>
            </div>
        </div>
    </div>

    <div class="section tiles" style="">
        <div class="shadow left" style=""></div>
        <div class="shadow right" style=""></div>
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <h2>title intro</h2>
    ...
    <div class="section quote">
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <blockquote>I make photo’s as a return ticket to a beautiful moment</blockquote>
                </div>
            </div>
        </div>
    </div>
